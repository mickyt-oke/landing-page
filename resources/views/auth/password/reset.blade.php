...
<head>
    ...
    <title>Reset Password | Foreigners Registration</title>
        ...
        <div class="card shadow-sm border-0">
            <div class="card-body p-4 p-md-5 text-center">
                ...
                <div style="width:64px;height:64px;background:#e3f2fd;border-radius:50%;display:flex;align-items:center;justify-content:center;margin:0 auto 24px;">
                    <i class="fas fa-key fa-2x" style="color:#003087;"></i>
                </div>

                <h2 style="color:#003087;font-size:1.4rem;margin-bottom:12px;">Set New Password</h2>
